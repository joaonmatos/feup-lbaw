...
function voteHandler() {
    if (this.status == 200) {
        ...
        let current_score = Number(document.getElementById('card-voting-display').childNodes[2].nodeValue);
        document.getElementById('card-voting-display').childNodes[2].nodeValue = current_score + rating;
    }
}

function vote(story_id, rating) {
    let request = { 'story_id': story_id, 'rating': rating };
